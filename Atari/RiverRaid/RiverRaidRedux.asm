...
TRAINER         = 1             ; enable training mode
...
SEED_LO         = $01           ; 14 change "to go, where no one has gone before" :)
SEED_HI         = $A8
...
; main game constants:
NUM_BLOCKS      = 6             ; JCTS 6 max. number of block on screen
...
JET_Y           = 19            ; JCTS 19 fixed y-position for jet
MIN_MISSILE     = JET_Y-6       ; starting position of player missile
MAX_MISSILE     = NUM_LINES+1
MISSILE_SPEED   = 12             ; JCTS 6 y-speed of the jet missile
ROAD_HEIGHT     = 13            ; number of lines for road
INTRO_SCROLL    = 48             ; JCTS 48 counter for scrolling into new game
...
playerColor     = $FF           ;               EF YELLOW/BLACK
...
.notHit:
  ...
  ELSE
       BIT    zero1             ; JCTS
;       BIT    CXP0FB-$30        ; 3   JCTS           jet hit PF?
  ENDIF
       BPL    .noPFCrash        ; 2
       STX    PFCrashFlag       ; 3
.noPFCrash:
...
HouseCol:
       ...
       .byte BLACK, LIGHT_GREY, LIGHT_GREY, GREY, GREY
FuelCol:
       .byte LIGHT_GREY, LIGHT_GREY, LIGHT_GREY, RED, RED, RED
       .byte LIGHT_GREY, LIGHT_GREY, LIGHT_GREY, RED, RED, RED
HelicopterCol:
       .byte CYAN, CYAN, RED, CYAN, ORANGE, ORANGE
  IF NTSC
PlaneCol:
       .byte $AC, $9C, $8C
ShipCol:
